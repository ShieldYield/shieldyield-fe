                          ...
                          <tbody className="divide-y divide-zinc-800/30">
                            {bridgeHistory.map((msg: any) => (
                              <tr key={msg.messageId} className="hover:bg-zinc-800/20 transition-colors group">
                                ...
                                <td className="px-6 py-5 whitespace-nowrap">
                                  <span className={`inline-flex items-center px-2 py-0.5 rounded text-[9px] font-black uppercase  ${msg.status === 'SUCCESS' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' :
